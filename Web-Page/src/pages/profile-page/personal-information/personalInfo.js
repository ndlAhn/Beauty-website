                ...
                <form className="survey-form">
                    ...
                    <div className="personal-survey-field">
                        <div className="info-field">
                            <label className="personal-label" htmlFor ="Uname">Name:</label>
                            <input className="profile-input" type="text" id="Uname" name="Uname" required ></input>
                        </div>
                        <div className="info-field">
                            <label htmlFor="dob" className="personal-label">Date of birth:</label>
                        ...
                        <div className="info-field">
                            ...
                            <div className="personal-gender">
                                ...
                                <label htmlFor="male" className="personal-gender-label">Male</label>
                            </div>
                            <div className="personal-gender">
                                <input type="radio" id="female" name="female" value="female" className="personal-gender-input"/>
                                <label htmlFor="female" className="personal-gender-label">Female</label>   
                            </div>  
                        </div>
                        <div className="info-field">
                            <label htmlFor ="skintype" className="personal-label" >Skin type:</label>
                        ...
                        <div className="info-field">
                            <label htmlFor ="skin-prob" className="personal-label" >Skin problem:</label>
                        ...
                        <label htmlFor ="price-segment" className="personal-label-price">Price segments (optional):</label>
                        <div className="price-segments">
                            
                                <div className="personal-price">
                                    <input className="personal-segment-input" type="checkbox" id="drug-store"></input>
                                    <label className="personal-segment-label" htmlFor="drug-store">Drug-store</label>
                                </div>
                                <div className="personal-price">
                                    <input className="personal-segment-input" type="checkbox" id="mid-end"></input> 
                                    <label className="personal-segment-label" htmlFor="mid-end" >Mid-end</label>
                                </div>
                                <div className="personal-price">
                                    <input className="personal-segment-input" type="checkbox" id="high-end"></input>
                                    <label className="personal-segment-label" type="checkbox" id="high-end">High-end</label>
                                </div>
